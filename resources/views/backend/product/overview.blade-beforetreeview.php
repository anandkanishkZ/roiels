    ...
    <div class="row">
            ...
            <div class="row" style="background-color: whitesmoke;padding:15px;border-radius: 1%;border-right: 19px solid #fff;">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        {{Form::text('slug', old('slug'), ['class' => 'form-control', 'placeholder' => 'Enter Slug', 'id' => 'slug','readonly'])}}
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <label for="photo2" class="no-require">Feature Image (Back Side)</label>
                        {{Form::file('photo2', null, ['class' => 'form-control'])}}
                        @include('backend.includes.single_input_validation', ['field' => 'photo2'])
                        <br/>
                        @if($page == 'edit')
                            <img src="{{asset($image_path . '/' . $data['row']->image2)}}" height="90" width="90" alt="{{$data['row']->title}}">
                        @endif
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item has-treeview" style="margin-left:30px;">
              <a href="#" class="nav-link">
                 @if($page == 'edit')
                  @if(in_array($subcategory->id, $assignedSubcategory))
                  <input type="checkbox" name="subcategory_id[]" value="{{$subcategory->id}}" checked>
                  @else
