<div class="col-md-7">
    <div class="form-group">
        ...
        {{Form::select('type', $data['types'], null, ['class'=> 'form-control', 'placeholder' => 'Choose One'])}}
        @include('backend.includes.single_input_validation', ['field' => 'type'])
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        {{Form::text('slug', null, ['class'=> 'form-control', 'placeholder' => 'Enter Slug','id' => 'slug','readonly'])}}
        @include('backend.includes.single_input_validation', ['field' => 'slug'])
    </div>
    <div class="form-group">
        <label for="title">Link</label>
        {{Form::url('link', null, ['class'=> 'form-control', 'placeholder' => 'Enter Link','id' => 'link'])}}
        @include('backend.includes.single_input_validation', ['field' => 'link'])
    </div>
    <div class="form-group">
