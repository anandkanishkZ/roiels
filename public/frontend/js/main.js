...
jQuery(document).ready(function($) {
    ...
    // Bestseller2 owl slider script
    $("#nav-bestseller2 .next").click(function() {
        $("#owl-bestseller2").trigger('owl.next');
    });
    $("#nav-bestseller2 .prev").click(function() {
        $("#owl-bestseller2").trigger('owl.prev');
    });

    $("#owl-bestseller2").owlCarousel({
        // Most important owl features
        items: 4,
        itemsCustom: false,
        itemsDesktop: [1199, 3],
    ...
    // Summer sale2 owl slider script
    $("#nav-summer-sale2 .next").click(function() {
        $("#owl-summer-sale2").trigger('owl.next');
    });
    $("#nav-summer-sale2 .prev").click(function() {
        $("#owl-summer-sale2").trigger('owl.prev');
    });

    $("#owl-summer-sale2").owlCarousel({
        // Most important owl features
        items: 4,
        itemsCustom: false,
        itemsDesktop: [1199, 3],
