...
{
    protected $base_route = 'backend.company';
    protected $view_path = 'backend.company';
    protected $image_path = 'images/company';
    ...
    {
        $action = 'Create';
        $data['types'] = ['about_us' => 'About Us', 'why_us' => 'Why Us'];
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = Company::create($request->all());
        if($data['row']){
