...
{
    protected $base_route = 'backend.ticketing';
    protected $view_path = 'backend.ticketing';
    protected $image_path = 'images/ticketing';
    protected $panel =  'Ticketing';
    /**
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = Ticketing::create($request->all());
        if($data['row']){
