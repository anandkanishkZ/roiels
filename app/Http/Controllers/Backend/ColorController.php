...
{
    protected $base_route = 'backend.color';
    protected $view_path = 'backend.color';
    protected $image_path = 'images/color';
    protected $panel =  'Color';
    /**
