...
{
    protected $base_route = 'backend.vendor';
    protected $view_path = 'backend.vendor';
    protected $image_path = 'images/vendor';
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = About::create($request->all());
        if($data['row']){
