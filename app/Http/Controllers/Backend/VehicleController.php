...
class VehicleController extends Controller
{
    ...
    protected $view_path = 'backend.vehicle';
    protected $image_path = 'images/vehicle';
    protected $panel =  'Vehicle Rent Service';
    /**
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = Vehicle::create($request->all());
        if($data['row']){
