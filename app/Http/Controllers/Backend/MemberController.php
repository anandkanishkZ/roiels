...
{
    protected $base_route = 'backend.member';
    protected $view_path = 'backend.member';
    protected $image_path = 'images/member';
    protected $panel =  'Executive Members';
    /**
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = Member::create($request->all());
        if($data['row']){
