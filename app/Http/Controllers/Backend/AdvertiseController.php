...
{
    protected $base_route = 'backend.advertise';
    protected $view_path = 'backend.advertise';
    protected $image_path = 'images/advertise';
    protected $panel =  'Advertise';
    /**
    ...
    {
        $action = 'List';
        $data['rows'] = Advertise::orderBy('rank','asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data['row'] = Advertise::create($request->all());
        if($data['row']){
