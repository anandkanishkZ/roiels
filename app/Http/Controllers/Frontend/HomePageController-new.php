...
class HomePageController extends Controller
{
    ...
    public function homepage(){
        ...
        $data['newProducts'] = Product::where('status',1)->orderBy('created_at','desc')->limit(12)->get();

        $data['subCategoryLeatherBags'] = Subcategory::where('id',1)->where('status',1)->get()[0];
         $data['subCategoryLeatherBelts'] = Subcategory::where('id',2)->where('status',1)->get()[0];
         $data['subCategoryLeatherWallets'] = Subcategory::where('id',3)->where('status',1)->get()[0];
