...
class HomePageController extends Controller
{
    ...
    public function homepage(){
        $action = 'Home Page';
        $data['sliders'] = Slider::where('status',1)->orderBy('rank','asc')->get();
        ...
        $data['newProducts'] = Product::where('status',1)->orderBy('created_at','desc')->limit(6)->get();
        $data['latestProducts'] = Product::where('status',1)->where('offer','!=', '')->orderBy('created_at','desc')->limit(6)->get();
        $data['electronicNewArrivals'] = Product::where('status',1)->orderBy('created_at','desc')->limit(6)->get();
        $data['electronics'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category2'] = Category::where('status',1)->where('id','2')->get()[0];
        $data['category3'] = Category::where('status',1)->where('id','4')->get()[0];
        $data['category4'] = Category::where('status',1)->where('id','4')->get()[0];
        $data['category5'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category6'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category7'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category8'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category9'] = Category::where('status',1)->where('id','1')->get()[0];
        $data['category10'] = Category::where('status',1)->where('id','1')->get()[0];
    ...
    public function productList($slug){
        ...
        if(count($data['rows']) > 0) {
            $data['products'] = $data['rows'][0]->products()->paginate(12);
