...
class CartController extends Controller
{
    ...
    protected $panel = 'Cart';
      ...
      if($wholeSaleData){
          ...
          $wSize = $wholeSaleData->wholesale_size;
          $price = ceil($unitPrice);
          $options = ['size' => $wSize, 'color' => $color, 'wholesale' => 'yes'];
      } else{
          if($size){
              $pSize = ProductSize::find($size);
              $price = $pSize->size_price;
          } else{
            $price = $request->price;
          }
    ...
    public function removeWishListCart(Request $request,$rowID){
